...
const LawyerDetailse = () => {
    ...
    const {name,speciality, experience, licenseNumber, availability, fees,image} = singleLawyer || { }
  ...
  <div className="card-body text-center">
    <h2 className="text-black font-bold text-4xl text-center">Lawyer’s Profile Details</h2>
  ...
  <div className="card-body">
   ...
   <p>License No : {licenseNumber}</p>
      ...
      <p>Availability <button className='text-blue-500 bg-green-200 rounded-2xl'>{availability}</button></p>
    <div className="card-actions ">
        <p className='mr-8'>Consultation Fee :<span className='text-green-500 ml-8'>TK: {fees}</span></p>
...
<div className="card bg-base-100 mt-12 shadow-sm">
  <div className="card-body text-center">
    <h2 className="text-black font-bold text-4xl text-center">Book an Appointment</h2>
    <div className='flex justify-between'>
        <h2>Availability</h2>
        <button className=' text-green-700 rounded-xl bg-blue-200'>Lawyer  Available Today</button>
    </div>
  </div>
  <button className="w-auto border-yellow-950 border-radius-2 bg-amber-100 rounded-2xl ml-3 mr-3 mb-3 h-9">Due to high patient volume, we are currently accepting appointments for today only. We appreciate your.</button>
  <button className="w-auto border-yellow-950 border-radius-2 bg-green-600 rounded-2xl ml-3 mr-3 mb-3 h-9 text-white">Book Appointment Now</button>
